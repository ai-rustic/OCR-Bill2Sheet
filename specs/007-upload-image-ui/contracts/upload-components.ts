/**
 * TypeScript Interface Contracts for Upload Image UI Components
 *
 * These interfaces define the component contracts for the upload image feature.
 * Since this is a frontend-only feature with no backend API, these contracts
 * represent component interfaces and state management contracts.
 */
